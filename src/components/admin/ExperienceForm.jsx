...
export default function ExperienceForm({ initialData, onSubmit, onCancel, submitting }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="pt-4 border-t border-light-border dark:border-dark-border space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5">End Date (kosongkan jika masih berjalan)</label>
            <input
              type="month"
              value={form.endDate}
